...
public class SettingFragment extends BaseFragment implements View.OnTouchListener {
    ...
    @InjectView(R.id.ll_app_timer)
    private LinearLayout mllAppTimer;
    ...
    private void initView() {
        ...
        mllAppTimer.setOnClickListener(v -> {
            // 进入App设定界面
            ((MainActivity) getActivity()).replaceFragment(R.id.main_fragments, new AppTimerFragment(), null);
        });
